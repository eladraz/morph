...
//        {
//            if (capacity < 0)
//                throw new System.ArgumentOutOfRangeException("capacity", "Needs a non-negative number");
//            if (!(growFactor >= 1.0F && growFactor <= 10.0F))
//                throw new System.ArgumentOutOfRangeException("growFactor", "Queue growth factor must be between 1.0 and 10.0, inclusive");
...
//                    Math.Math.Min(_size, length_from_head));
